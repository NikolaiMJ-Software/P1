...
void personalization_function(states state, int personalization);
void legitimacy_function(states state, int legitimacy);
int third_electors = 0, rep_electors = 0, dem_electors = 0;
void parameters(states* USA, double minority_proportionality, int personalization, int legitimacy, int comprehensibility) {
    for (int i = 0; i < STATES; i++) {
        comprehensibility_function(USA[i], comprehensibility);
        minority_and_proportionality_function(USA[i], minority_proportionality);
        personalization_function(USA[i], personalization);
        legitimacy_function(USA[i], legitimacy);
    }
}
void comprehensibility_function(states state, int comprehensibility) {
